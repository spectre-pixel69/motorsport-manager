...
export const TIRE_BRANDS: TireBrand[] = [
  ...
  { id: 'pirella', name: 'Pirella', color: '#e8c50e', grip: 85, durability: 72 },
  { id: 'ironclad', name: 'IronClad Tire Co', color: '#8a1520', grip: 76, durability: 86 },
  { id: 'dustdevil', name: 'DustDevil Rubber', color: '#c96a1e', grip: 79, durability: 80 },
];
